...
public class MemberService {
    ...
    public ResponseEntity<Void> updateLearningHistory(Authentication authentication){
        ...
        member.getLearningHistory().update(
                ...
                parsedOutput.goal(),
                member);
        System.out.println("MemberService - 학습 이력 업데이트 완료... 개인화된 문제 생성 시작... (0/3)");
        // 업데이트된 학습 이력을 이용해 문제를 생성해오자
        PersonalizedQuestionGeneratedResponse response = questionService.generatePersonalizedQuestion(member);
        System.out.println("MemberService - 개인화된 문제 생성 완료...");
